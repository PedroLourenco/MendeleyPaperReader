...
public class ReadersActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mergeAdapter.addAdapter(new ListTitleAdapter(getApplicationContext(), getResources().getString(R.string.countryStatus), mAdapterCountryStatus, R.layout.list_view_readers_section));
		mergeAdapter.addAdapter(mAdapterCountryStatus);
		mergeAdapter.addAdapter(new ListTitleAdapter(getApplicationContext(), getResources().getString(R.string.academicStatus), mAdapterAcademicStatus, R.layout.list_view_readers_section));
